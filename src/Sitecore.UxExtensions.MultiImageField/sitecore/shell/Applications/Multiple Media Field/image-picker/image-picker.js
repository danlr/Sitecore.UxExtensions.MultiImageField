// based on https://github.com/rvera/image-picker/tree/master/image-picker
// dirty double-click handling line 321
(function() {
    var ImagePicker,
        ImagePickerOption,
    ...
    ImagePickerOption = (function() {
        function ImagePickerOption(option_element, picker, opts1) {
            ...
            this.dblclicked = bind(this.dblclicked, this);
        ...
        ImagePickerOption.prototype.dblclicked = function(event) {
            this.picker.toggle(this, event);
            if (this.opts.dblclicked != null) {
                this.opts.dblclicked.call(this.picker.select, this, event);
            }
        };
        ...
        ImagePickerOption.prototype.create_node = function() {
            ...
            this.node = jQuery("<li/>");
            var itemId = this.option.val();
            this.node.data("item-id", itemId);
            if (this.option.data("font_awesome")) {
                ...
                image.attr("alt", this.option.data("item-path"));
                image.attr("title", this.option.data("item-path"));
            }
            ...
            this.node.on("dblclick",
                function() {
                    window.scForm.postRequest('', '', '', 'contenteditor:launchtab(url=' + itemId + ')');
                });
